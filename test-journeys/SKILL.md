...
- Missing ACs or vague AC wording -> `audit-ac`
- Missing/incorrect journey transitions -> `write-journeys`
- Spec-vs-code contradictions -> `sync-spec-code`
...
- Suggest: "Next: consider running `write-e2e` for stable validated flows"
