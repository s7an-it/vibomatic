...
chain:
  lanes:
    brownfield-conversion: { position: 1, prev: null, next: work-item-sync }
  progressive: true
  self_verify: true
...
- Invoke next skill: `work-item-sync --progressive --lane brownfield-conversion`

**If `--progressive` flag is absent:**
- Report results to user
- Suggest: "Next: consider running `work-item-sync`"
