...
- `convert` (brownfield): existing code/docs/process already exist and must be
  adapted before the full vibomatic pipeline governs the repo.
...
Then run the greenfield lane end to end. For prompts effectively meaning
"build me an app", run automatically unless a real blocker or contradiction
appears.
