...
|---|----------|------|-------|------|
| 1 | Vision refinement proposal | `vibomatic/vision-refine-proposal.md` | write-vision | REFINE |
| 2 | Team Collaborator persona | `vibomatic/P2-team-collaborator.md` | build-personas | Add New (Mode 3) |
| 3 | Feature ship brief | `vibomatic/feature-ship-brief-realtime-collab.md` | validate-feature | Validate |
| 4 | Real-time collab feature spec | `vibomatic/feature-realtime-collab.md` | write-spec | New (referencing existing) |
| 5 | Spec-code sync report | `vibomatic/sync-spec-code-report.md` | sync-spec-code | Convert |
| 6 | Real-time collab journey | `vibomatic/J02-realtime-collab.feature.md` | write-journeys | Expand (Mode 2) |
