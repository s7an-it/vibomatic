...
You are evaluating the output of a vibomatic pipeline skill for **actionability** — whether the next skill in the chain can use this output without ambiguity.
