...
| `comparison` | "Compare svc vs obra vs raw on [feature]" | Three parallel worktrees, same feature three ways, measure delta. |
...
Fixes are real commits, not documentation. The autopilot improves svc's skills as it tests them.
