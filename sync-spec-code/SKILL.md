...
description: >
  ...
  Notes in the spec to reflect current code state. Two modes: single feature ("sync-spec-code
  feature-learning") or all features ("sync-spec-code"). Triggers on: "sync-spec-code",
  ...
  Does NOT define acceptance criteria — use audit-ac for that. In brownfield repos,
