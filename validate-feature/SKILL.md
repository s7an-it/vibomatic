...
|--------|---------------|
| Standard product feature, clear scope, personas exist | **/brainstorming** (or **write-spec** in vibomatic) — "The business case is solid. Let me invoke brainstorming with this brief as context for technical design." |
