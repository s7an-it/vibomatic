...
description: >
  Use after writing-technical-design to challenge the chosen approach with
...
chain:
  lanes:
    greenfield: { position: 10, prev: writing-technical-design, next: spec-style-sync }
    brownfield-feature: { position: 6, prev: writing-technical-design, next: spec-style-sync }
  progressive: true
  self_verify: true
...
`writing-technical-design`. This skill contests that choice with research,
...
Adapted for vibomatic's spec-first pipeline with full upstream context.

**Announce at start:** "I'm using the solution-explorer skill to challenge the technical design with alternatives."

## Why This Exists

LLMs satisfice. When `writing-technical-design` picks an architecture, it
...
Unlike a standalone exploration, vibomatic has accumulated context. Use it.
...
<summary of what writing-technical-design chose and why>
...
- **Gains:** <why writing-technical-design chose this>
...
- Suggest: "Next: run `spec-style-sync`"
