# Vibomatic Autopilot — Aggregate Report
...
| 6 | Marketing interop documented | **MET** | coreyhaines-interop.md maps all 12 downstream skills to vibomatic context sections. |
...
|---|-------|-----------|-----------|-------------|
| 1 | vision-sync | ✅ Create | ✅ Refine | bootstrap + convert |
| 2 | persona-builder | ✅ Mode 7 (Auto) | ✅ Mode 3 (Add) | bootstrap + convert |
| 3 | workflow-compass | ✅ Full routing | — (skipped, already verified) | bootstrap |
| 4 | feature-discovery | ✅ Greenfield | ✅ Validate existing | bootstrap + convert |
| 5 | writing-spec | ✅ 2 specs (36 ACs) | ✅ 1 spec (15 ACs) | bootstrap + convert |
| 6 | spec-ac-sync | ✅ Audit clean | — (via S3 spec) | bootstrap |
| 7 | journey-sync | ✅ Mode 1 (Bootstrap) | ✅ Mode 2 (Expand) | bootstrap + convert |
| 8 | writing-ux-design | ✅ 7 screens, 5 flows | — | bootstrap |
| 9 | writing-ui-design | ✅ Design system + UI | — | bootstrap |
...
| 17 | agentic-e2e-playwright | ⚠️ Simulated (26 cases) | — | simulated |
| 18 | feature-marketing-insights | ✅ Mode 4 + Mode 2 | — | bootstrap |
| 19 | framework-test | ✅ This analysis | — | meta |
...
|---|----------|----|----|----------|
| 1 | vision-sync → persona-builder | ✅ | ✅ | Both modes |
| 2 | persona-builder → workflow-compass | ✅ | — | Bootstrap |
| 3 | workflow-compass → feature-discovery | ✅ | — | Bootstrap |
| 4 | feature-discovery → writing-spec | ✅ | ✅ | Both modes |
| 5 | writing-spec → spec-ac-sync | ✅ | — | Bootstrap |
| 6 | spec-ac-sync → journey-sync | ✅ | — | Bootstrap |
| 7 | journey-sync → writing-ux-design | ✅ | — | Bootstrap |
...
- spec-code-sync drift detection across features
...
| **C2: Spec-as-index reduces tokens** | Greenfield — no code to index. | spec-code-sync checked existing specs, not code. | **PARTIALLY SUPPORTED** |
...
3. **Run S4 (adversarial)** to test feature-discovery's clarification behavior on "make it faster and better"
