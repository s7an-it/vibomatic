...
**Repo Mode:** bootstrap  
**Origin:** vision-sync (intent=create, mode=scratch)
...
Detailed personas will be developed by the persona-builder skill in Phase 2.
...
This section will be populated as artifacts are created through the vibomatic pipeline.
...
2. Proposals are generated by running `vision-sync intent=refine mode=grounded`.
