...
### Skill 2: `persona-builder`
- **Invoke:** `Skill: persona-builder`
...
### Skill 3: `workflow-compass`
- **Invoke:** `Skill: workflow-compass`
- **Input:** Project state (vision exists, personas exist, no specs yet)
- **Expected behavior:** Recommends `feature-discovery` as next skill
- **Output:** Routing recommendation
- **Verify:** It suggests feature-discovery, not writing-spec directly

### Skill 4: `feature-discovery`
- **Invoke:** `Skill: feature-discovery`
...
### Skill 6: `spec-ac-sync`
- **Invoke:** `Skill: spec-ac-sync`
- **Input:** Feature specs
...
### Skill 7: `journey-sync`
- **Invoke:** `Skill: journey-sync`
...
### Skill 8: `writing-ux-design`
- **Invoke:** `Skill: writing-ux-design`
...
### Skill 9: `writing-ui-design`
- **Invoke:** `Skill: writing-ui-design`
...
### Skill 10: `writing-technical-design`
- **Invoke:** `Skill: writing-technical-design`
...
### Skill 11: `review-protocol`
- **Invoke:** `Skill: review-protocol`
...
### Skill 12: `writing-change-set`
- **Invoke:** `Skill: writing-change-set`
...
### Skill 14: `verifying-promotion`
- **Invoke:** `Skill: verifying-promotion`
...
### Skill 15: `spec-code-sync`
- **Invoke:** `Skill: spec-code-sync`
...
### Skill 16: `journey-qa-ac-testing`
- **Invoke:** `Skill: journey-qa-ac-testing`
...
### Skill 17: `agentic-e2e-playwright`
- **Invoke:** `Skill: agentic-e2e-playwright`
- **Input:** Journeys + ACs
...
### Skill 18: `feature-marketing-insights`
- **Invoke:** `Skill: feature-marketing-insights`
- **Input:** Feature specs
- **Expected behavior:** Mode 4 (Foundation) then Mode 2 (Single Feature)
- **Output:** `.agents/product-marketing-context.md`

### Skill 19: `framework-test`
- **Invoke:** `Skill: framework-test`
...
**Total expected user interactions:** ~8-12 (vision approval, persona approval, feature-discovery questions, spec clarifications, UX choices, review decisions)
