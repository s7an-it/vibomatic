...
In **bootstrap (S1)**, feature-discovery has no existing specs to validate against -- it creates the initial feature inventory from the vision document. In **convert (S3)**, the skill:
