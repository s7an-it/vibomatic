...
2. Proceed to persona-builder (Mode 3: Add New Persona) for the Team Collaborator persona
3. Run feature-discovery to generate the Feature Ship Brief for the new capability

---

## Convert Mode Notes

This artifact demonstrates **REFINE mode** behavior in vision-sync:
