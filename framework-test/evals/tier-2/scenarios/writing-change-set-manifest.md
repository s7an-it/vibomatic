# Scenario: writing-change-set manifest production
...
```
Use the writing-change-set skill to produce an implementation manifest for the todo management feature. The feature spec is BASELINED at docs/specs/features/feature-todo-management.md.
```
...
If `--progressive` were set, the next skill would be `executing-change-set`.
